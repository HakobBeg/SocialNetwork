...
const Messages = (props) => {
    ...
    let friendField = props.store.state.users.map(item => <Friend path={item.id} userName={item.userName} userLastName={item.userLastName}/>);
    return (
        <div className={messages.messageBox}>
            ...
            <div className={messages.messagesContent}>
                ...
                <div className={messages.dialog}>
                    ...
                    <Route path = '/messages/4'  render={()=><MessageCont user={props.store.state.users[4]}/>}/>
                    <Route path = '/messages/5'  render={()=><MessageCont user={props.store.state.users[5]}/>}/>
                    <Route path = '/messages/6'  render={()=><MessageCont user={props.store.state.users[6]}/>}/>
                    <Route path = '/messages/7'  render={()=><MessageCont user={props.store.state.users[7]}/>}/>
                    <Route path = '/messages/8'  render={()=><MessageCont user={props.store.state.users[8]}/>}/>
                    <Route path = '/messages/9'  render={()=><MessageCont user={props.store.state.users[9]}/>}/>
                </div>
                </div>
            </div>
